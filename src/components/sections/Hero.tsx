...
// 1. Importe as ferramentas de tradução
import { useTranslation, Trans } from 'react-i18next';
import heroImage from '../../assets/images/hero.webp';
import { COMPANY_FULL_NAME } from '../../utils/env';

const Hero = () => {
  // 2. Inicialize o hook de tradução
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-gem-pink via-gem-purple to-gem-cyan bg-clip-text text-transparent whitespace-pre-line">
              {/* Traduz o título e respeita as quebras de linha (\n) do JSON */}
              {t('hero.title')}
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#contact" className="btn bg-gradient-to-r from-gem-pink to-gem-purple text-white hover:shadow-neon-pink transition-all duration-300 min-w-[260px] text-center">
                {/* 3. Use <Trans> para o botão com a variável */}
                <Trans i18nKey="hero.cta_main" values={{ company: COMPANY_FULL_NAME }} />
              </a>
              <a href="#about" className="btn btn-outline border-gem-violet text-white hover:bg-gem-violet/10 hover:border-gem-cyan transition-all duration-300 min-w-[150px] text-center">
                {t('hero.cta_secondary')}
              </a>
            </div>
          </motion.div>

          {/* Seção da imagem (sem alterações) */}
          <motion.div
